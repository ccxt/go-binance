...
// Endpoints
var (
	// Public endpoints: bookTicker, partial/diff depth (high-frequency)
	BaseWsPublicMainUrl          = "wss://fstream.binance.com/public"
	BaseWsPublicTestnetUrl       = "wss://stream.binancefuture.com/public"
	BaseWsPublicDemoURL          = "wss://fstream.binancefuture.com/public"
	...
	// Market endpoints: aggTrade, markPrice, kline, miniTicker, ticker, liquidation, compositeIndex, BLVT
	BaseWsMarketMainUrl          = "wss://fstream.binance.com/market"
	BaseWsMarketTestnetUrl       = "wss://stream.binancefuture.com/market"
	BaseWsMarketDemoURL          = "wss://fstream.binancefuture.com/market"
	...
	BaseWsPrivateMainUrl    = "wss://fstream.binance.com/private"
	BaseWsPrivateTestnetUrl = "wss://stream.binancefuture.com/private"
	BaseWsPrivateDemoURL    = "wss://fstream.binancefuture.com/private"
...
// getWsPublicEndpoint returns the public single-stream endpoint (bookTicker, depth)
...
// getCombinedPublicEndpoint returns the public combined-stream endpoint (bookTicker, depth)
...
// getWsMarketEndpoint returns the market single-stream endpoint (aggTrade, markPrice, kline, ticker, etc.)
...
// getCombinedMarketEndpoint returns the market combined-stream endpoint (aggTrade, markPrice, kline, ticker, etc.)
...
// getWsPrivateEndpoint returns the private single-stream endpoint (user data)
